...
class AsyncAgentMemoryCollection:
    ...
    async def query(
        ...
        return await asyncio.to_thread(
            ...
            query_vector=query_vector, query_text=query_text, k=k,
    ...
    async def prune_memories(
        ...
        return await asyncio.to_thread(
            ...
            max_age_seconds=max_age_seconds, min_importance_score=min_importance_score,
            max_last_accessed_seconds=max_last_accessed_seconds, filter_logic=filter_logic,
            custom_filter_sql_addon=custom_filter_sql_addon, dry_run=dry_run
        )
